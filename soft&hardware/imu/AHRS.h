...
#define ACCEL_X_MIN ((float)-17052.00)
#define ACCEL_X_MAX ((float)20164.00)
#define ACCEL_Y_MIN ((float)-16856.00)
#define ACCEL_Y_MAX ((float)17868.00)
#define ACCEL_Z_MIN ((float)-19600.00)
#define ACCEL_Z_MAX ((float)23320.00)
// #define DEBUG_DRIFT_CORRECTION

// Magnetometer (standard calibration)
// "magn x,y,z (min/max) = X_MIN/X_MAX  Y_MIN/Y_MAX  Z_MIN/Z_MAX"
// -682.27/263.36  -635.00/430.45  -533.18/493.36
#define MAGN_X_MIN ((float)-1383.00)
#define MAGN_X_MAX ((float)1562.00)
#define MAGN_Y_MIN ((float)-2482.00)
#define MAGN_Y_MAX ((float)525.00)
#define MAGN_Z_MIN ((float)-1522.00)
#define MAGN_Z_MAX ((float)1560.00)
...
#define GYRO_AVERAGE_OFFSET_X ((float)-356.68)
#define GYRO_AVERAGE_OFFSET_Y ((float)-82.74)
#define GYRO_AVERAGE_OFFSET_Z ((float)30.99)
...
#define GYRO_GAIN 0.007634                         // Same gain on all axes(LSB_250)
#define GYRO_SCALED_RAD(x) (x * TO_RAD(GYRO_GAIN)) // Calculate the scaled gyro readings in radians per second
// DCM parameters
#define Kp_ROLLPITCH 0.0002f
#define Ki_ROLLPITCH 0.000000005f
#define Kp_YAW 0.0002f
#define Ki_YAW 0.000000005f
// Stuff
#define GRAVITY 16384.0f              // "1G reference" used for DCM filter and accelerometer calibration(LSB_2G)
...
public:
    ...
    virtual void delay(uint16_t delayMS); // This function is default Arduino delay(), but can be overridden in a derived class to provide a custom delay implementation.
